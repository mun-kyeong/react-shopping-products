    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { css: ModalContainer, children: [
          ...
          /* @__PURE__ */ jsx$1("footer", { css: ModalFooter, children: footer })
        ] })
      ]
    }
  );
...
const ShoppingContext = reactExports.createContext(null);
...
function CartProduct({
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsx$1("img", { src: imageUrl, css: ProductImg }),
        ...
        /* @__PURE__ */ jsx$1("div", { css: deleteButton, children: /* @__PURE__ */ jsx$1(Button, { onClick: handleDelete, style: "ghost", children: "삭제" }) })
      ]
    }
  );
}
...
function ShopPage() {
  const [isOpen, setIsOpen] = reactExports.useState(false);
  const { cart, product, handleChangeCategory, handleChangeFilter } = useShoppingContext();
  const handleClose = () => {
    setIsOpen(false);
  };
  const handleOpen = () => {
...
function App() {
  return /* @__PURE__ */ jsx$1(ShoppingProvider, { children: /* @__PURE__ */ jsxs(
    "div",
    {
      css: css`
          display: flex;
